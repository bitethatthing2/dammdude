  ...
  public: {
    Tables: {
      ...
      admin_logs: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["admin_id"]
            isOneToOne: false
            referencedRelation: "permanent_pack_members"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "admin_logs_admin_id_fkey"
      ...
      bartender_orders: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "bar_locations"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "bartender_orders_location_id_fkey"
      ...
      item_modifier_groups: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["item_id"]
            isOneToOne: false
            referencedRelation: "menu_items_with_modifier_groups"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "item_modifier_groups_item_id_fkey"
      ...
      wolf_private_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_wolf_private_messages_from_user"
            columns: ["from_user_id"]
            isOneToOne: false
            referencedRelation: "active_orders_dashboard"
            referencedColumns: ["customer_id"]
          ...
          {
            foreignKeyName: "fk_wolf_private_messages_to_user"
            columns: ["to_user_id"]
            isOneToOne: false
            referencedRelation: "active_orders_dashboard"
            referencedColumns: ["customer_id"]
      ...
      wolfpack_event_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "wolfpack_event_participants_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "wolfpack_events"
            referencedColumns: ["id"]
          },
        ]
      }
      wolfpack_event_votes: {
        Row: {
          created_at: string
          event_id: string
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "wolfpack_event_votes_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "wolfpack_events"
            referencedColumns: ["id"]
      ...
      wolfpack_members_unified: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_wolfpack_members_unified_location_id"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "bar_locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_wolfpack_members_unified_user_id"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "active_orders_dashboard"
            referencedColumns: ["customer_id"]
          ...
          {
            foreignKeyName: "wolfpack_members_unified_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "bar_locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "wolfpack_members_unified_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "active_orders_dashboard"
            referencedColumns: ["customer_id"]
    ...
    Views: {
      ...
      menu_item_modifier_summary: {
        Row: {
          available_modifiers: string | null
      ...
      menu_items_with_modifier_groups: {
        Row: {
          category: Json | null
          description: string | null
          display_order: number | null
      ...
      permanent_pack_members: {
        Row: {
          avatar_url: string | null
          days_as_permanent_member: number | null
          email: string | null
          first_name: string | null
          id: string | null
          instagram_handle: string | null
          ...
          permanent_member_since: string | null
          vibe_status: string | null
          wolfpack_display_name: string | null
        }
        Relationships: []
      }
      ...
      wolfpack_memberships: {
        Row: {
          ...
          table_location: string | null
          user_id: string | null
          "wolfpack_sessions.bar_location_id": string | null
          "wolfpack_sessions.bar_locations.name": string | null
          "wolfpack_sessions.created_at": string | null
          "wolfpack_sessions.expires_at": string | null
          "wolfpack_sessions.id": string | null
          "wolfpack_sessions.is_active": boolean | null
          "wolfpack_sessions.max_members": number | null
          "wolfpack_sessions.member_count": number | null
        }
        Relationships: [
          {
            foreignKeyName: "fk_wolfpack_members_unified_location_id"
          ...
          {
            foreignKeyName: "wolfpack_sessions_bar_location_id_fkey"
            columns: ["wolfpack_sessions.bar_location_id"]
            isOneToOne: false
            referencedRelation: "bar_locations"
            referencedColumns: ["id"]
          },
      ...
      wolfpack_memberships_with_sessions: {
        Row: {
          avatar_url: string | null
          display_name: string | null
          id: string | null
